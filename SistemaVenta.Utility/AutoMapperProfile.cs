...
namespace SistemaVenta.Utility
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            #region Usuario
            //tenemos propiedades con nombre diferente, o tipo de dato diferente
            CreateMap<Usuario, UsuarioDTO>()
                //para propiedad RolDescripcion que se encuentra en destino, vamos a obtener información desde nuestro origen
                //con propiedades idRolNavigation.Nombre
                .ForMember(destino =>
