    ...
    public class ProductoService : IProductoService
    {
        ...
        public async Task<ProductoDTO> Crear(ProductoDTO modelo)
        {
            try
            {
                ...
                if (productoCreado.IdProducto == 0)
                    throw new TaskCanceledException("No fue posible crear el producto.");
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                ...
                if (!respuesta) throw new TaskCanceledException("No fue posible editar el producto.");
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                ...
                if (!respuesta) throw new TaskCanceledException("No fue posible eliminar el producto.");
